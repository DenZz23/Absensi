            ...
            <form action="/izincuti/store" method="POST" id="frmizin">
                @csrf
                    <div class="form-group">
                        <input type="text" class="form-control datepicker" id="tgl_izin_dari" name="tgl_izin_dari" placeholder="Dari Tanggal" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control datepicker" id="tgl_izin_sampai" name="tgl_izin_sampai" placeholder="Sampai Tanggal" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="jml_hari" name="jml_hari" placeholder="Jumlah Hari" autocomplete="off" readonly>
                    </div>
                    <div class="form-group">
                        <select name="kode_cuti" id="kode_cuti" class="form-control selectmaterialize" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input type="text" name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan" autocomplete="off"></input>
                    </div>
                <div class="form-group">
