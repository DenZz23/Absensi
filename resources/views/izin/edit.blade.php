            ...
            <form action="/izinabsen/{{ $dataizin->kode_izin }}/update" method="POST" id="frmizin">
                @csrf
                    <div class="form-group">
                        <input type="text" class="form-control datepicker" value="{{ $dataizin->tgl_izin_dari }}" id="tgl_izin_dari" name="tgl_izin_dari" placeholder="Dari Tanggal" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control datepicker" value="{{ $dataizin->tgl_izin_sampai }}" id="tgl_izin_sampai" name="tgl_izin_sampai" placeholder="Sampai Tanggal" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="jml_hari" name="jml_hari" placeholder="Jumlah Hari" autocomplete="off" readonly>
                    </div>
                    <div class="form-group">
                        <input type="text" name="keterangan" id="keterangan" value="{{ $dataizin->keterangan }}" class="form-control" placeholder="Keterangan"></input>
                    </div>
                <div class="form-group">
