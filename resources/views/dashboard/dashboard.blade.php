...
<div class="section mt-2" id="presence-section">
                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <span></span>
                                    {{ $presensihariini != null ? $presensihariini->jam_in : 'Belum Absen' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="rekappresensi">
        <h3> Rekap Presensi Bulan {{ $namabulan[$bulanini] }} Tahun {{ $tahunini }}
        </h3>
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div
                        class="card-body text-center" style="padding: 12px 12px !important;line-height: 0.8rem;">
                                ...
                                <div class="datapresensi">
                                    ...
                                    <div>
                                        ...
                                        @php
                                            ...
                                            // $jmlterlambatdesimal = hitungjamterlambatdesimal($jam_masuk,$jam_presensi);
                                        @endphp
                                            <span class="danger">Terlambat {{ $jmlterlambat }} Jam</span>
                                            @else
