<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
      ...
      <h1 class="navbar-brand navbar-brand-autodark">
        <a href=".">
          <img src="{{ asset('tabler/static/lgnavbar.svg') }}" width="150px">
        </a>
      </h1>
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is(['pegawai','divisi']) ? 'show' : '' }}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['pegawai','divisi']) ? 'true' : '' }}" >
            ...
            <div class="dropdown-menu {{ request()->is(['pegawai','divisi', 'cuti']) ? 'show' : '' }}">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item {{ request()->is(['pegawai']) ? 'active' : '' }}" href="/pegawai">
                    Data Pegawai
                  </a>
