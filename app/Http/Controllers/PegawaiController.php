...
class PegawaiController extends Controller
{
    ...
    {
        $query = Pegawai::query();
        $query->select('pegawai.*', 'nama_div');
        $query->join('divisi', 'pegawai.kode_div', '=', 'divisi.kode_div');
        ...
        if (!empty($request->kode_div)) {
            $query->where('pegawai.kode_div', $request->kode_div);
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($e->getCode() == 23000) {
                ...
                $message = "-Silahkan Periksa Kembali Data Yang Di Inputkan!";
            }
